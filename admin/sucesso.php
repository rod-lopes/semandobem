...
<section class="hero-area bg-1 text-center overly">
	...
	<div class="container">
		<div class="row">
            ...
            <div class="col-12">
          <div class="alert alert-danger text-success" role="alert">Cadastro efetuado com sucesso. Insira suas credenciais novamente para acessar a nossa plataforma</div>                                                    
        </div>
