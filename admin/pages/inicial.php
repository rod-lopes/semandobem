                ...
                <div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Todos os Projetos Cadastrados</h3>
<?php 
	...
	$query = $pdo->query("SELECT * from projetos LIMIT $inicio, $limite_resultado");
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Tooltip on top" class="view" href="index.php?d=detalhe_projeto&id=<?php echo $res[$i]['id']; ?>">
													<i class="fa fa-eye"></i>
												</a>		
											</li>
                                            <!--
