...
if (!empty($dados['enviar'])) {
  ...
  if(count($erro) == 0) {
    ...
    $query2 = "INSERT INTO projetos (nome, descricao_curta, descricao, cod_categoria, telefone, cidade, uf, email_site, data_lancamento, id_user) VALUES (:nome, :descricao_curta, :descricao, :categoria, :telefone, :cidade, :uf, :email_site, '$data_lancamento', '$id_user' ) ";
...
?>
        ...
        ?>
				...
				<div class="widget personal-info">
					<h3 class="widget-header user">Cadastrar um Projeto</h3>
					<form form action="" method="post" >
						<!-- First Name -->
						<div class="form-group">
						    <label for="first-name">Nome do Projeto</label>
						    <input type="text" name="nome" class="form-control" id="first-name">
						</div>						
				</div>
				...
				<div class="widget change-password">
					<h3 class="widget-header user">Descrição do seu projeto</h3>
						...
						<div class="form-group">
						    ...
						    <input type="text" name="descricao_curta" class="form-control" id="current-password">
						</div>
						<!-- New Password -->
						<div class="form-group">
						    <label for="new-password">Descrição de seu projeto.</label>
						    <textarea class="form-control" name="descricao" id="story" name="story" rows="4"></textarea>
						</div>
				</div>
				...
				<div class="widget personal-info">
					<h3 class="widget-header user">Selecione a Categoria de seu projeto</h3>
						...
						<div class="form-group">
                            ...
                            ?>
                            <option value="<?php echo $res[$i]['id'] ?>"><?php echo $res[$i]['categoria'] ?></option>
				...
				<div class="widget change-email mb-0">
					<h3 class="widget-header user">Localidade do Projeto</h3>
						...
						<div class="form-group">
						    ...
						    <input type="text" name="cidade" class="form-control" id="current-email">
						</div>
                        <!-- Current Password -->
						<div class="form-group">
						    <!-- Versão UF e Estado para HTML -->
                        <select class="form-control" name="uf" id="estado" name="estado">
                ...
                <div class="widget change-email mb-0">
					<h3 class="widget-header user">Dados Para Contato</h3>
						...
						<div class="form-group">
						    ...
						    <input type="text" name="telefone" class="form-control" id="current-email">
						</div>
                        <!-- Current Password -->
						<div class="form-group">
						    <!-- Versão UF e Estado para HTML -->
						    <label for="current-email">Email ou Site </label>
						    <input type="text" name="email_site"class="form-control" id="current-email"
						</div>
				</div>
                <!-- Submit Button -->
